...
async def main():
    ...
    try:
        ...
        print(f"   ✅ BIOS Manager: Templates loaded for {server_config['device_type']}")
        ...
        print(f"   CLI: orchestrator provision {server_config['server_id']} {server_config['device_type']} {server_config['target_ipmi_ip']}")
