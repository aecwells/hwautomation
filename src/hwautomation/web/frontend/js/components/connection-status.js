...
class ConnectionStatus {
   ...
   */
  updateStatus() {
    const socketConnected = this.stateManager.getState(
      "socket.connected",
      false,
    );
  ...
  getDetailedStatusText(status) {
    const details = {
      connected:
        "Full connection established - WebSocket and API are both healthy",
      "api-only":
        "API connection established - WebSocket connection unavailable",
