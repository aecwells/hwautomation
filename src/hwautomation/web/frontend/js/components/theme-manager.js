...
class ThemeManager {
    ...
    createThemeToggle() {
        ...
        if (navbarNav) {
            ...
            this.toggleButton = themeToggleItem.querySelector('[data-bs-toggle="theme"]');
    ...
    updateToggleButton() {
        ...
        const lightIcon = this.toggleButton.querySelector('[data-theme-icon="light"]');
        const darkIcon = this.toggleButton.querySelector('[data-theme-icon="dark"]');
