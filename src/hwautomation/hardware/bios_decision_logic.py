...
class BiosSettingMethodSelector:
    ...
    def _calculate_performance_estimate(self, redfish_settings: Dict[str, Any],
        ...
        return {
            ...
            'estimated_total_time': max(redfish_time, vendor_time),  # Parallel execution
    ...
    def validate_redfish_capabilities(self, available_settings: Set[str]) -> Dict[str, bool]:
        """
        ...
        for setting_name, method_info in self.setting_methods.items():
            if method_info.priority in [SettingPriority.REDFISH_PREFERRED, SettingPriority.REDFISH_FALLBACK]:
