...
class PullOperationHandler(BaseOperationHandler):
    ...
    def execute(self, target_ip: str, username: str, password: str, **kwargs) -> ET.Element:
    ...
    def validate_inputs(self, target_ip: str, username: str, password: str, **kwargs) -> list:
    ...
    def pull_via_redfish(self, target_ip: str, username: str, password: str) -> Optional[ET.Element]:
    ...
    def pull_via_vendor_tools(self, target_ip: str, username: str, password: str, vendor: str) -> Optional[ET.Element]:
    ...
    def _pull_dell_config(self, target_ip: str, username: str, password: str) -> ET.Element:
    ...
    def _pull_hpe_config(self, target_ip: str, username: str, password: str) -> ET.Element:
    ...
    def _pull_supermicro_config(self, target_ip: str, username: str, password: str) -> ET.Element:
