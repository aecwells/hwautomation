...
class StructuredFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        # Add module context
        record.module_context = record.name.split('.')[-1] if '.' in record.name else record.name
...
def load_logging_config(config_path: Optional[Path] = None, environment: str = 'development') -> Dict[str, Any]:
    """
    ...
    if correlation_id:
        ...
        class CorrelationAdapter(logging.LoggerAdapter):
            ...
            def _log(self, level, msg, args, exc_info=None, extra=None, stack_info=False):
                ...
                self.logger._log(level, msg, args, exc_info=exc_info, extra=extra, stack_info=stack_info)
