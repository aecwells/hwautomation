...
class TestBiosConfigManager(unittest.TestCase):
    ...
    def test_preserve_settings(self):
        ...
        self.assertFalse(
            self.manager._should_preserve_setting("IntelHyperThreadingTech")
        )
