...
def test_imports():
    ...
    tests = [
        ("BiosConfigManager", "from hwautomation.hardware.bios_config import BiosConfigManager"),
        ("Hardware package", "from hwautomation.hardware import BiosConfigManager, IpmiManager, RedFishManager"),
...
def test_basic_functionality():
    ...
    try:
        ...
        print(f"✓ Template rules loaded: {len(template_rules.get('template_rules', {}))}")
