...
def test_basic_functionality():
    ...
    try:
        ...
        try:
            ...
            print(f"✓ Configuration loading (expected to fail without config file): {e}")
...
def check_dependencies():
    ...
    for package, description in optional_packages:
        try:
            ...
            print(f"⚠ {package} - {description} (optional, install with: pip install {package})")
...
if __name__ == "__main__":
    ...
    if imports_ok:
        ...
        if functionality_ok:
            ...
            print("2. Install optional dependencies: pip install requests requests-oauthlib pyyaml")
