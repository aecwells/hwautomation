    ...
    try:
        ...
        if available_machines:
            ...
            for machine in available_machines[:3]:  # Show first 3
                ...
                print(f"    CPU: {machine.get('cpu_count', 0)}, Memory: {machine.get('memory_display', 'Unknown')}")
        ...
        if machines:
            ...
            for machine in machines:
                ...
                print(f"    Owner: {machine.get('owner', {}).get('username', 'None') if machine.get('owner') else 'None'}")
