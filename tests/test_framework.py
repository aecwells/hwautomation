...
class PerformanceTestMixin:
    ...
    def assert_performance_threshold(self, operation_name: str, max_average_time: float, 
                                   max_p95_time: float, min_success_rate: float = 0.95):
...
class MockDataFactory:
    ...
    @staticmethod
    def create_server_data(server_id: str = "test-server-001", 
                          device_type: str = "a1.c5.large") -> Dict[str, Any]:
    ...
    @staticmethod
    def create_workflow_data(workflow_id: str = "wf-test-001", 
...
def mock_maas_client():
    ...
    client.get_machines.return_value = [
        MockDataFactory.create_maas_machine_data(f"node-{i:03d}")
        for i in range(3)
    ]
...
class TestAssertions:
    ...
    def assert_workflow_status(workflow_data: Dict[str, Any], expected_status: str):
        ...
        assert workflow_data.get("status") == expected_status, \
    ...
    def assert_server_provisioned(server_data: Dict[str, Any]):
        ...
        assert server_data.get("status_name") == "Ready", \
...
def generate_performance_report(metrics: Dict[str, PerformanceMetrics], 
