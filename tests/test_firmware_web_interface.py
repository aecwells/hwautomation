...
class TestFirmwareWebManager:
    ...
    def test_firmware_web_manager_initialization(self, firmware_web_manager, mock_dependencies):
        """Test firmware web manager initializes correctly."""
        assert firmware_web_manager.firmware_manager == mock_dependencies['firmware_manager']
        assert firmware_web_manager.workflow_manager == mock_dependencies['workflow_manager']
    ...
    def test_get_firmware_inventory_empty_database(self, firmware_web_manager, mock_dependencies):
    ...
    def test_get_firmware_inventory_with_servers(self, firmware_web_manager, mock_dependencies):
        ...
        mock_dependencies['firmware_manager'].discover_firmware_files.return_value = mock_firmware_files
    ...
    def test_schedule_firmware_update_success(self, firmware_web_manager, mock_dependencies):
    ...
    def test_schedule_firmware_update_partial_failure(self, firmware_web_manager, mock_dependencies):
...
class TestFirmwareWebIntegration:
    ...
    def test_schedule_firmware_update_api_route(self, client):
        ...
        with patch('hwautomation.web.firmware_routes.firmware_web_manager') as mock_manager:
            ...
            response = client.post('/firmware/api/schedule',
